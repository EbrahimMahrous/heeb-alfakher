...
import arReturns from "./ar/returns.json";
import arSubcategory from "./ar/subcategory.json";
...
import enReturns from "./en/returns.json";
import enSubcategory from "./en/subcategory.json";
