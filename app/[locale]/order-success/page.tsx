...
export default function OrderSuccessPage() {
  ...
  // Clear cart and checkout data when the success page is visited
  useEffect(() => {
    clearCart();
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        {/* Back to home and auto redirect */}
        ...
        <div className="mt-8 border-t pt-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 text-green-600 hover:text-green-700 font-medium transition"
          >
            <svg
